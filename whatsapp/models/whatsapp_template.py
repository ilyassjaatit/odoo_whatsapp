    ...
    def action_create_sidebar_action(self):
        ...
        for template in self:
            ...
            action = ActWindow.create({
                ...
                'context': "{'default_template_id' : %d, 'whatsapp_composition_mode': 'guess', 'default_res_ids': active_ids, 'default_res_id': active_id}" % (template.id),
                'view_mode': 'form',
                'view_id': view.id,
                'target': 'new',
